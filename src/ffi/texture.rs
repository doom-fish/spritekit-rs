...
extern "C" {
    ...
    pub fn sk_texture_from_rgba_bytes(bytes: *const u8, length: usize, width: usize, height: usize) -> *mut c_void;
    pub fn sk_texture_subrect(texture: *mut c_void, x: f64, y: f64, width: f64, height: f64) -> *mut c_void;
