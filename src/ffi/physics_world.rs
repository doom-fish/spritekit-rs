...
extern "C" {
    ...
    pub fn sk_physics_world_body_in_rect(world: *mut c_void, x: f64, y: f64, width: f64, height: f64) -> *mut c_void;
    pub fn sk_physics_world_body_along_ray(world: *mut c_void, start_x: f64, start_y: f64, end_x: f64, end_y: f64) -> *mut c_void;
}
