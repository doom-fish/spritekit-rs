...
fn main() {
    ...
    let node = spritekit::SpriteNode::with_color(spritekit::Color::green(), CGSize::new(16.0, 16.0))
        .expect("sprite");
    ...
    assert!(world.body_in_rect(spritekit::CGRect::new(-10.0, -10.0, 20.0, 20.0)).is_some());
    assert!(world
